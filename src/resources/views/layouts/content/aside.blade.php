...
<aside id="left-panel" >
    ...
    <nav>
        ...
        <ul style="">
            ...
            <li >
                <a href="{{ route('bitacora.index') }}"  title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Bitacora</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
            </li>

            <li >
                <a href="/backups"  title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Backup</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
            </li>
            <li >
                <a href="{{ route('personalizacion') }}"  title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Personalizacion</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
            </li>
            <li >
                <a href="{{ route('impresora') }}"  title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">Impresora</span><b class="collapse-sign"><em class="fa fa-minus-square-o"></em></b></a>
            </li>
