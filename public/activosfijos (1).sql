...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-10-2017 a las 23:55:12
...
--
-- Estructura de tabla para la tabla `causadetrasferencia`
--
...
--
-- Estructura de tabla para la tabla `causasdebajas`
--
...
--
-- Estructura de tabla para la tabla `depreciacionactivos`
--
...
--
-- Estructura de tabla para la tabla `depreciaciones`
--
...
--
-- Estructura de tabla para la tabla `detallealta`
--
...
--
-- Estructura de tabla para la tabla `detallebaja`
--
...
--
-- Estructura de tabla para la tabla `detalletrasferencia`
--
...
--
-- Estructura de tabla para la tabla `esquemacontables`
--
...
--
-- Volcado de datos para la tabla `esquemacontables`
--
...
--
-- Estructura de tabla para la tabla `revaluotecnico`
--
...
--
-- Estructura de tabla para la tabla `tipodecambio`
--
...
--
-- Volcado de datos para la tabla `tipodecambio`
--
...
--
-- Estructura de tabla para la tabla `ventasdeactivos`
--
...
--
-- Estructura Stand-in para la vista `view_activos`
...
--
-- Estructura para la vista `view_activos`
--
...
ALTER TABLE `activos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_activos_tipoDeCambio1_idx` (`tipoDeCambio_id`),
  ADD KEY `fk_activos_proveedores1_idx` (`proveedores_id`),
  ADD KEY `fk_activos_areas1_idx` (`areas_id`),
  ADD KEY `fk_activos_grupos1_idx` (`grupos_id`);
...
ALTER TABLE `alta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_alta_empleados1_idx` (`empleados_id`);
...
ALTER TABLE `areas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_areas_sucursales1_idx` (`sucursales_id`);
...
ALTER TABLE `bajas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_bajas_causasDeBajas1_idx` (`causasDeBajas_id`),
  ADD KEY `fk_bajas_tipoDeCambio1_idx` (`tipoDeCambio_id`);
...
--
-- Indices de la tabla `causadetrasferencia`
--
ALTER TABLE `causadetrasferencia`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `causasdebajas`
--
ALTER TABLE `causasdebajas`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `cuentas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cuentas_activos1_idx` (`activos_id`),
  ADD KEY `fk_cuentas_cuentas1_idx` (`cuentas_id`),
  ADD KEY `fk_cuentas_esquemaContables1_idx` (`esquemaContables_id`);

--
-- Indices de la tabla `depreciacionactivos`
--
ALTER TABLE `depreciacionactivos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_depreciaciones_has_activos_activos1_idx` (`activos_id`),
  ADD KEY `fk_depreciaciones_has_activos_depreciaciones1_idx` (`depreciaciones_id`);

--
-- Indices de la tabla `depreciaciones`
--
ALTER TABLE `depreciaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_depreciaciones_gestiones1_idx` (`gestiones_id`),
  ADD KEY `fk_depreciaciones_tipoDeCambio1_idx` (`tipoDeCambio_id`);

--
-- Indices de la tabla `detallealta`
--
ALTER TABLE `detallealta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_activos_has_alta_alta1_idx` (`alta_id`),
  ADD KEY `fk_activos_has_alta_activos1_idx` (`activos_id`);

--
-- Indices de la tabla `detallebaja`
--
ALTER TABLE `detallebaja`
  ADD PRIMARY KEY (`cantidad`),
  ADD KEY `fk_bajas_has_activos_activos1_idx` (`activos_id`),
  ADD KEY `fk_bajas_has_activos_bajas1_idx` (`bajas_id`);

--
-- Indices de la tabla `detalletrasferencia`
--
ALTER TABLE `detalletrasferencia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_activos_has_transferencias_transferencias1_idx` (`transferencias_id`),
  ADD KEY `fk_activos_has_transferencias_activos1_idx` (`activos_id`);
...
ALTER TABLE `empleados`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_empleados_empleados1_idx` (`empleados_id`),
  ADD KEY `fk_empleados_areas1_idx` (`areas_id`),
...
--
-- Indices de la tabla `esquemacontables`
--
ALTER TABLE `esquemacontables`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `plancuenta`
  ADD PRIMARY KEY (`cuentas_id`,`gestiones_id`),
  ADD KEY `fk_cuentas_has_gestiones_gestiones1_idx` (`gestiones_id`),
  ADD KEY `fk_cuentas_has_gestiones_cuentas1_idx` (`cuentas_id`);
...
--
-- Indices de la tabla `revaluotecnico`
--
ALTER TABLE `revaluotecnico`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_revaluoTecnico_activos1_idx` (`activos_id`);
...
ALTER TABLE `sucursales`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_sucursales_empresas1_idx` (`empresas_id`);
...
ALTER TABLE `telefonos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_telefonos_empleados1_idx` (`empleados_id`);

--
-- Indices de la tabla `tipodecambio`
--
...
ALTER TABLE `transferencias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_transferencias_empleados1_idx` (`empleados_id`),
  ADD KEY `fk_transferencias_causaDeTrasferencia1_idx` (`causaDeTrasferencia_id`);

--
-- Indices de la tabla `users`
--
ALTER TABLE `users`
  ADD PRIMARY KEY (`id`,`empleados_id`),
  ADD KEY `fk_users_empleados1_idx` (`empleados_id`);

--
-- Indices de la tabla `ventasdeactivos`
--
ALTER TABLE `ventasdeactivos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_ventasDeActivos_bajas1_idx` (`bajas_id`);
...
--
-- AUTO_INCREMENT de la tabla `causadetrasferencia`
--
ALTER TABLE `causadetrasferencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `causasdebajas`
--
ALTER TABLE `causasdebajas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `cuentas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `depreciacionactivos`
--
ALTER TABLE `depreciacionactivos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `depreciaciones`
--
ALTER TABLE `depreciaciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `detallealta`
--
ALTER TABLE `detallealta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `detallebaja`
--
ALTER TABLE `detallebaja`
  MODIFY `cantidad` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `detalletrasferencia`
--
ALTER TABLE `detalletrasferencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `esquemacontables`
--
ALTER TABLE `esquemacontables`
...
--
-- AUTO_INCREMENT de la tabla `revaluotecnico`
--
ALTER TABLE `revaluotecnico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `tipodecambio`
--
ALTER TABLE `tipodecambio`
...
ALTER TABLE `users`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `ventasdeactivos`
--
ALTER TABLE `ventasdeactivos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `activos`
  ADD CONSTRAINT `fk_activos_areas1` FOREIGN KEY (`areas_id`) REFERENCES `areas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activos_grupos1` FOREIGN KEY (`grupos_id`) REFERENCES `grupos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activos_proveedores1` FOREIGN KEY (`proveedores_id`) REFERENCES `proveedores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activos_tipoDeCambio1` FOREIGN KEY (`tipoDeCambio_id`) REFERENCES `tipodecambio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `alta`
--
ALTER TABLE `alta`
  ADD CONSTRAINT `fk_alta_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `areas`
--
ALTER TABLE `areas`
  ADD CONSTRAINT `fk_areas_sucursales1` FOREIGN KEY (`sucursales_id`) REFERENCES `sucursales` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `bajas`
--
ALTER TABLE `bajas`
  ADD CONSTRAINT `fk_bajas_causasDeBajas1` FOREIGN KEY (`causasDeBajas_id`) REFERENCES `causasdebajas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_bajas_tipoDeCambio1` FOREIGN KEY (`tipoDeCambio_id`) REFERENCES `tipodecambio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cuentas`
--
ALTER TABLE `cuentas`
  ADD CONSTRAINT `fk_cuentas_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cuentas_cuentas1` FOREIGN KEY (`cuentas_id`) REFERENCES `cuentas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cuentas_esquemaContables1` FOREIGN KEY (`esquemaContables_id`) REFERENCES `esquemacontables` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `depreciacionactivos`
--
ALTER TABLE `depreciacionactivos`
  ADD CONSTRAINT `fk_depreciaciones_has_activos_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_depreciaciones_has_activos_depreciaciones1` FOREIGN KEY (`depreciaciones_id`) REFERENCES `depreciaciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `depreciaciones`
--
ALTER TABLE `depreciaciones`
  ADD CONSTRAINT `fk_depreciaciones_gestiones1` FOREIGN KEY (`gestiones_id`) REFERENCES `gestiones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_depreciaciones_tipoDeCambio1` FOREIGN KEY (`tipoDeCambio_id`) REFERENCES `tipodecambio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detallealta`
--
ALTER TABLE `detallealta`
  ADD CONSTRAINT `fk_activos_has_alta_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activos_has_alta_alta1` FOREIGN KEY (`alta_id`) REFERENCES `alta` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detallebaja`
--
ALTER TABLE `detallebaja`
  ADD CONSTRAINT `fk_bajas_has_activos_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_bajas_has_activos_bajas1` FOREIGN KEY (`bajas_id`) REFERENCES `bajas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalletrasferencia`
--
ALTER TABLE `detalletrasferencia`
  ADD CONSTRAINT `fk_activos_has_transferencias_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_activos_has_transferencias_transferencias1` FOREIGN KEY (`transferencias_id`) REFERENCES `transferencias` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `fk_empleados_areas1` FOREIGN KEY (`areas_id`) REFERENCES `areas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empleados_cargos1` FOREIGN KEY (`cargos_id`) REFERENCES `cargos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empleados_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `plancuenta`
  ADD CONSTRAINT `fk_cuentas_has_gestiones_cuentas1` FOREIGN KEY (`cuentas_id`) REFERENCES `cuentas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_cuentas_has_gestiones_gestiones1` FOREIGN KEY (`gestiones_id`) REFERENCES `gestiones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `revaluotecnico`
--
ALTER TABLE `revaluotecnico`
  ADD CONSTRAINT `fk_revaluoTecnico_activos1` FOREIGN KEY (`activos_id`) REFERENCES `activos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `sucursales`
  ADD CONSTRAINT `fk_sucursales_empresas1` FOREIGN KEY (`empresas_id`) REFERENCES `empresas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `telefonos`
--
ALTER TABLE `telefonos`
  ADD CONSTRAINT `fk_telefonos_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `transferencias`
--
ALTER TABLE `transferencias`
  ADD CONSTRAINT `fk_transferencias_causaDeTrasferencia1` FOREIGN KEY (`causaDeTrasferencia_id`) REFERENCES `causadetrasferencia` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_transferencias_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `users`
--
ALTER TABLE `users`
  ADD CONSTRAINT `fk_users_empleados1` FOREIGN KEY (`empleados_id`) REFERENCES `empleados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `ventasdeactivos`
--
ALTER TABLE `ventasdeactivos`
  ADD CONSTRAINT `fk_ventasDeActivos_bajas1` FOREIGN KEY (`bajas_id`) REFERENCES `bajas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
