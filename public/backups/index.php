...
$lang ='es';  //indice of the "lang_...json" file with texts
...
$_SESSION['mysql'] = ['host'=>'localhost', 'user'=>'root', 'pass'=>'', 'dbname'=>'activofijo'];
            ...
            <div class="panel panel-default">
                ...
                <br>
                 ...
                 <div class=" card border-warning mb-3">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" type="submit"><a href="../" >Volver </a></button>
								

                      <h1 class="lead">'. sprintf($bk->langTxt('msg_conn_to'), $_SESSION['mysql']['dbname']) .'</h1><div id="bmd_re">'. $bmd_re .'</div>
...
';
  ...
  if($tables['er'] =='') $html .=
      '
<h2 id="tab_frm_cht" class="tabvi">'. $bk->langTxt('msg_show_tables') .'</h2>

<h2 id="tab_frm_zip">'. $bk->langTxt('msg_show_files') .'</h2><br>'. $tables['f'] . $bk->getListZip($dir);
  else $html ='<div id="bmd_re">'. $tables['er'] .'</div>'. $frm;
}

$html .= '<div id="mp">Copia de seguridad de base de datos Activos Fijos<br></div>';
...
<meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="../../smar/css/bootstrap.min.css)}}">
    <link rel="stylesheet" type="text/css" media="screen" href="../../smar/css/font-awesome.min.css">

    <!-- SmartAdmin Styles : Please note (smartadmin-production.css) was created using LESS variables -->
    <link rel="stylesheet" type="text/css" media="screen" href="../../smar/css/smartadmin-production.min.css">
    <link rel="stylesheet" type="text/css" media="screen" href="../../smar/css/smartadmin-skins.min.css">

    <link rel="shortcut icon" href="../../smar/img/cat/logo.bmp" type="image/x-icon">

    <link rel="icon" href="../../smar/img/LOGO.gif" type="image/x-icon">

    <link rel="stylesheet" type="text/css" media="screen" href="../../smar/css/your_style.css">
        ...
        for(var i2=0; i2<zip_files.length; i2++){
          if(zip_files[i2].checked === true){
            ...
            if(conf_del){
              ...
              if(e.target.id !='get_file') bmdLoading();
              frm_zip.submit();
            }
            break;
          }
